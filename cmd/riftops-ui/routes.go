...
func dashboardRoutes() []dashboardRoute {
	return []dashboardRoute{
		...
		{Pattern: "/api/proxy/status", Handler: proxyStatusHandler, API: true},
		{Pattern: "/api/proxy/setup", Handler: proxySetupHandler, API: true},
		{Pattern: "/api/proxy/clear", Handler: proxyClearHandler, API: true},
		...
		{Pattern: "/api/window/minimize", Handler: windowMinimizeHandler, API: true},
		{Pattern: "/api/window/maximize", Handler: windowMaximizeHandler, API: true},
		{Pattern: "/api/window/close", Handler: windowCloseHandler, API: true},
		{Pattern: "/api/window/state", Handler: windowStateHandler, API: true},
		...
		{Pattern: "/api/lcu/champ-select/champion-swaps", Handler: lcuChampSelectChampionSwapsHandler, API: true},
		{Pattern: "/api/lcu/champ-select/ongoing-swaps", Handler: lcuOngoingChampSelectSwapsHandler, API: true},
		{Pattern: "/api/lcu/champ-select/ongoing-swap/clear", Handler: lcuOngoingChampSelectSwapClearHandler, API: true},
		{Pattern: "/api/lcu/matchmaking/status", Handler: lcuMatchmakingStatusHandler, API: true},
		{Pattern: "/api/lcu/matchmaking/restrictions", Handler: lcuLeaverBusterHandler, API: true},
		{Pattern: "/api/lcu/matchmaking/restrictions/dismiss", Handler: lcuLeaverDismissHandler, API: true},
		...
		{Pattern: "/api/lcu/spectator/config", Handler: lcuSpectatorConfigHandler, API: true},
		{Pattern: "/api/lcu/spectator/launch", Handler: lcuSpectatorLaunchHandler, API: true},
		{Pattern: "/api/lcu/custom-games", Handler: lcuCustomGamesHandler, API: true},
		{Pattern: "/api/lcu/custom-games/refresh", Handler: lcuCustomGamesRefreshHandler, API: true},
		{Pattern: "/api/lcu/lobby-invitations/action", Handler: lcuLobbyInvitationActionHandler, API: true},
		{Pattern: "/api/lcu/chat/privacy", Handler: lcuChatPrivacyHandler, API: true},
		{Pattern: "/api/lcu/chat/mutes", Handler: lcuChatMutesHandler, API: true},
		{Pattern: "/api/lcu/chat/settings", Handler: lcuChatSettingsHandler, API: true},
		{Pattern: "/api/lcu/progress/missions", Handler: lcuMissionsHandler, API: true},
		{Pattern: "/api/lcu/progress/rewards", Handler: lcuRewardsHandler, API: true},
		{Pattern: "/api/lcu/progress/rewards/viewed", Handler: lcuRewardsViewedHandler, API: true},
		{Pattern: "/api/lcu/progress/rewards/replay", Handler: lcuRewardsReplayHandler, API: true},
		{Pattern: "/api/lcu/progress/mastery", Handler: lcuMasteryHandler, API: true},
		{Pattern: "/api/lcu/progress/mastery/notification/ack", Handler: lcuMasteryAckHandler, API: true},
		{Pattern: "/api/lcu/progress/mastery/reward-grant/dismiss", Handler: lcuMasteryGrantDismissHandler, API: true},
		{Pattern: "/api/lcu/mastery/scouting", Handler: lcuMasteryScoutingHandler, API: true},
		{Pattern: "/api/lcu/loadouts", Handler: lcuLoadoutsHandler, API: true},
