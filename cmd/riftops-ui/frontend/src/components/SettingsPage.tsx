  ...
  const handleManualUpdateCheck = async () => {
    ...
    try {
      ...
      if (res.available && res.release) {
        ...
        const ver = res.currentVersion || snapshot.Version || '2.10.3';
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 p-3 rounded-xl bg-dark-bg/50 border border-white/5">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <div className="flex items-center gap-2">
                      <strong className="text-xs font-mono font-medium text-white">{snapshot.Version ? `v${snapshot.Version}` : '2.10.3'}</strong>
                      <button
                        type="button"
